...
class SitemapSubscriber implements EventSubscriberInterface
{
    ...
    {
        $manufacturers = $this->doctrine->getRepository('ShopBundle:Manufacturer')->getArrayForSitemap();
    ...
    {
        $categories = $this->doctrine->getRepository('ShopBundle:Category')->getArrayForSitemap();
        $frequency = UrlConcrete::CHANGEFREQ_MONTHLY;
        $priority = 1;
    ...
    {
        $products = $this->doctrine->getRepository('ShopBundle:Product')->getArrayForSitemap();
        $frequency = UrlConcrete::CHANGEFREQ_MONTHLY;
        $priority = 0.7;
    ...
    {
        $staticPages = $this->doctrine->getRepository('ShopBundle:StaticPage')->getArrayForSitemap();
        $frequency = UrlConcrete::CHANGEFREQ_MONTHLY;
        $priority = 0.7;
        $date = new \DateTime();
